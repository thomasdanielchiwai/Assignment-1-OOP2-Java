// A program showing a car rental system
...
public class CarRentalSystem {
    public static void main(String[] args) {
        ...
        Car car3 = new Car("C003", "Ford Focus");
        agency.addCar(car1);
        agency.addCar(car2);
        agency.addCar(car3);

        Customer cust1 = new Customer("CU001", "Thomas");
        Customer cust2 = new Customer("CU002", "CHiwai");
        agency.addCustomer(cust1);
        agency.addCustomer(cust2);

        // Renting cars
        System.out.println("Renting Cars...");
        agency.rentCar("CU001", "C001");
        agency.rentCar("CU002", "C002");
